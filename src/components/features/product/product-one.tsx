...
function ProductOne ( props: ProductOneProps ) {
    const { product, adClass, openQuickview } = props;
    ...
    return (
        <div className={ `product shadow-media ${ adClass }` }>
            ...
            <div className="product-details">
                <a href="#" className={ `btn-wishlist` } title={ wish ? 'Remove from wishlist' : 'Add to wishlist' } onClick={ wishlistHandler }>
